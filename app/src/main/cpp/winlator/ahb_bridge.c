 ...
 *
 * Ported from Winlator-Ludashi-Plus (Direct Android Compositing). Compiled into
 * libwinlator.so. Provides five JNI functions:
 ...
 *
 * JNI symbols target com.winlator.renderer.AHardwareBufferPool (GameNative
 * package; the source fork used com.winlator.cmod.renderer).
 *
...
Java_com_winlator_renderer_AHardwareBufferPool_nativeCreateBuffer(
...
Java_com_winlator_renderer_AHardwareBufferPool_nativeDestroyBuffer(
...
Java_com_winlator_renderer_AHardwareBufferPool_nativeSendBufferToSocket(
 ...
 * --------------------------------------------------------------------------- */
JNIEXPORT jlong JNICALL
Java_com_winlator_renderer_AHardwareBufferPool_nativeReceiveBufferFromSocket(
 ...
 * --------------------------------------------------------------------------- */
JNIEXPORT jint JNICALL
Java_com_winlator_renderer_AHardwareBufferPool_nativeWaitFence(
